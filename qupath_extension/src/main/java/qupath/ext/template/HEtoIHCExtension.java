 ...
 * </pre>
 */
public class HEtoIHCExtension implements QuPathExtension, GitHubProject {
	
	private static final Logger logger = LoggerFactory.getLogger(HEtoIHCExtension.class);

	/**
	 * Display name for your extension
	 */
	private static final String EXTENSION_NAME = "HEtoIHC";

	/**
	 * Short description, used under 'Extensions > Installed extensions'
	 * TODO: define this
	 */
	private static final String EXTENSION_DESCRIPTION = "Converts histological images stained with Hematoxylin and Eosin into pseudo-Immunohistochemistry images.";
	...
	private void createStage() {
		if (stage == null) {
			try {
				stage = new Stage();
				Scene scene = new Scene(HEtoIHCInterfaceController.createInstance());
